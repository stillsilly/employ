define([], function () {
    return function (options, Ycallback, Ncallback) {
        //插件默认选项
        var datetime = false;
        var time = false;
            ...
            var str = '' +
                ...
                '<div id="datePage" class="page">' +
                    '<section>' +
                        ...
                        (theme == 'date' || theme == 'datetime' ? '<div id="datemark"><a id="markyear"></a><a id="markmonth"></a><a id="markday"></a></div>' : '') +
                        (theme == 'time' || theme == 'datetime' ? '<div id="timemark"><a id="markhour"></a><a id="markminut"></a><a id="marksecond"></a></div>' : '') +
                        '<div id="datescroll">' +
                            '<div id="yearwrapper">' +
                                '<ul></ul>' +
                            '</div>' +
